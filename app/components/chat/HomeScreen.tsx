    ...
    <div className="flex flex-col items-center justify-center flex-1 min-h-0 px-6 pb-10 overflow-y-auto">
      ...
      >
        ...
        <div className="relative flex items-center justify-center w-14 h-14 mb-6">
          ...
          {/* Orbit ring */}
          <div
            className="absolute w-[3.5rem] h-[3.5rem] rounded-full border border-violet-400/25 animate-spin"
        ...
        <h1 className="text-4xl font-semibold tracking-tight text-gray-900">
          Your Knowledge{" "}
          <span className="bg-gradient-to-r from-[#b9a7e8] via-[#e7b6c8] to-[#efb39a] bg-clip-text text-transparent">
            Assistant
          </span>
        </h1>
        <p
